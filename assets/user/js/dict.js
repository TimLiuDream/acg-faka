    ...
    constructor() {
        ...
        this.data = {
            ...
            "_commodity_delivery_way": [
                ...
                {id: 1, "name": format.color(i18n("手动发货"), "blue")},
            ],
            ...
            "_cash_wallet_type": [
                ...
                {id: 2, "name": format.badge(i18n("钱包余额"), "a-badge-danger")}
            ],
            "_cash_order_type": [
            ...
            "_cash_order_status": [
                {id: 0, "name": format.badge(i18n("银行处理中"), "a-badge-danger")},
                {id: 1, "name": format.badge(i18n("已到账"), "a-badge-success")},
                {id: 2, "name": format.badge(i18n("兑现失败"), "a-badge-dark")},
            ],
            "_user_status": [
                {
                    "id": 1,
                    "name": `<span class="text-success"><i class="fa-duotone fa-regular fa-circle-check text-success"></i> ${i18n('正常')}</span>`
                },
                {
                    "id": 0,
                    "name": `<span class="text-danger"><i class="fa-duotone fa-regular fa-circle-xmark text-danger"></i> ${i18n('封禁')}</span>`
                }
            ],
            "_bill_status": [
